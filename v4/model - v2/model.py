...
#Read csv files
df_train = pd.read_csv("./merged_data.csv", sep=';')
...
class_weights['anticipation'] = class_weights['anticipation'] + 1
class_weights['trust'] = class_weights['trust'] + 1
class_weights['surprise'] = class_weights['surprise'] + 1
